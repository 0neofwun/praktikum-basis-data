...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 07, 2026 at 06:51 AM
...
INSERT INTO `tbgaji` (`golongan`, `gajipokok`) VALUES
(1, 1500000),
(2, 2000000),
(3, 3500000),
(4, 5000000);
...
--
ALTER TABLE `tbpegawai`
  ADD CONSTRAINT `fk_golongan` FOREIGN KEY (`gol`) REFERENCES `tbgaji` (`golongan`);
COMMIT;
